...
class _EditCategoryState extends State<EditCategory> {
  ...
  void initState() {
    ...
    burmeseTextEditingController.text = widget.model.burmese;
    ...
    koreanTextEditingController.text = widget.model.korean;
    ...
    pashtoTextEditingController.text = widget.model.pashto;
    persianFarsiTextEditingController.text = widget.model.persianFarsi;
    ...
    vietnameseTextEditingController.text = widget.model.vietnamese;
    setState(() {
